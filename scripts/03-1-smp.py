...
class CageDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, data_path, split='train', transforms=None):
        ...
        self.filenames = glob.glob(os.path.join(data_path, 'dataset-1', split, '*.joblib'))
...
if __name__ == '__main__':
    ...
    results_dir = os.path.join(os.environ['HOME'], 'projects/aida/cage-aquaculture-mapping/results-1')
